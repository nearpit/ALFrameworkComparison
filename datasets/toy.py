...
class Toy(VectoralDataset):
    ...
    def obtain(self):
        ...
        x, y = make_moons(n_samples=non_honeypot_size, noise=0.2, random_state=self.random_seed)
        ...
        x_hp = self.make_hollow_circle(n_samples=self.configs["n_honeypot"], scale_factor=3, along_x=0.5, noise=0.15)
    ...
    def make_hollow_circle(self, n_samples, scale_factor=1, along_x=0.5, along_y=0.25, noise=None):
