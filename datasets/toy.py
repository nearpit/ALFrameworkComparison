...
class Toy(VectoralDataset):
    ...
    def obtain(self):
        ...
        x, y = make_blobs(n_samples=non_honeypot_size, centers=2, cluster_std=[0.05, 0.05], center_box=(-0.2, 0.2), random_state=42)
        x_hp, _ = make_blobs(n_samples=self.configs["n_honeypot"], centers=1, cluster_std=[0.05], center_box=(1, 0.1), random_state=42)
