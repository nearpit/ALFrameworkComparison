...
class ActiveLearning:
    ...
    def __init__(self, args):
        ...
        self.pool = core.Pool(data=Dataclass.get_data_dict(), torch_seed=self.random_seed, val_share=args.val_share)
    ...
    def run(self):
        ...
        for idx in range(self.budget):
            ...
            train_perf, val_perf, test_perf = self.clf.tune_model(n_trials=self.finetune_ntrials)
